package com.cronutils.rangesets;
...
public class CronRangeSetsTest {
    ...
    public void getRangesetsForValidExpressionUnix() throws Exception {
        ...
        Map<CronFieldName, RangeSet<Integer>> rangesets = CronRangeSets.instance(cron).getRangesets();
        ...
        for(CronFieldName fieldName : CronRangeSets.instance(cron).getRangesets().keySet()){
